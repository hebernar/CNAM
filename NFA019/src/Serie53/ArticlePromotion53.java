...
public class ArticlePromotion53 extends AbstractArticle {
	
	private int qtemin;
	private float reduc;
	
	public ArticlePromotion53 (int codearticle, String designation, float prixunitaire, int qtemin, float reduc) {
		super(codearticle, designation, prixunitaire);
		this.qtemin = qtemin;
		this.reduc = reduc;
	}
	
	public ArticlePromotion53 ()
	{}
