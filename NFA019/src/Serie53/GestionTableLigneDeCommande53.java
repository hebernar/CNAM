...
public class GestionTableLigneDeCommande53 implements InterfaceGestion<TableLigneDeCommande53<Integer>>{
	...
	public void menuGeneral(Object ...obj) throws AbandonException{
		...
		int choix;
		TableLigneDeCommande53<String> cde = (TableLigneDeCommande53<String>)obj[0];
	...
	public void supprimerArticleDeCommande(TableLigneDeCommande53<String> cde, int code) {
	...
	public void creer(Object ...obj) throws AbandonException,MenuPrecedentException{
		...
		TableLigneDeCommande53<String> cde = (TableLigneDeCommande53<String>)obj[0];
		TableArticles53 tabArt = (TableArticles53)obj[1];
		LigneDeCommande53 element = saisieLigneDeCommande(tabArt);
		if (element != null) {
			LigneDeCommande53 exist = cde.retourner(element.getCodearticle());
			if (exist == null) {
				cde.ajouter(element);
	...
	public LigneDeCommande53 saisieLigneDeCommande(TableArticles53 tabArt) throws AbandonException,MenuPrecedentException{
		...
		if (art != null) {
			...
			return (new LigneDeCommande53(code, qte));
		} else
			return null;
	}
