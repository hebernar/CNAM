...
public class ArticlePromotion42 extends AbstractArticle {
	
	private int qtemin;
	private float reduc;
	
	public ArticlePromotion42 (int codearticle, String designation, float prixunitaire, int qtemin, float reduc) {
		super(codearticle, designation, prixunitaire);
		this.qtemin = qtemin;
		this.reduc = reduc;
	}
	
	public ArticlePromotion42 ()
	{}
