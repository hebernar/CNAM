...
public class GestionTableArticle42 implements InterfaceGestion<TableArticles42>{
	...
	public void menuGeneral(Object ...obj) throws AbandonException{
		...
		int choix;
		TableArticles42 tabArt = (TableArticles42)obj[0];
		TableDesCommandes42 tabCde = (TableDesCommandes42)obj[1];
	...
	public void transformer(TableArticles42 tabArt) throws AbandonException,MenuPrecedentException {
		...
		if (art == null)
			...
			boolean promo = art instanceof ArticlePromotion42;
			String desi = art.getDesignation();
			float pu = art.getPrixunitaire();
			if (promo)
			{
				art = new Article42(code, desi, pu);
				tabArt.ajouter(art);
			}
			else
			{
				...
				art = new ArticlePromotion42(code, desi, pu, qte, reduc);
				tabArt.ajouter(art);
			}			
		}
	}
	...
	public void affichepromo(TableArticles42 tabArt) {
		if (tabArt.taille() == 0)
			es.affiche("aucun article en stock\n");
		else
	...
	public void creer(Object ...obj) throws AbandonException,MenuPrecedentException {
		...
		TableArticles42 tabArt = (TableArticles42)obj[0];
		Article42 art = saisieArticle42(tabArt);
		if (art != null) {
			tabArt.ajouter(art);
	...
	public Article42 saisieArticle42(TableArticles42 tabArt) throws AbandonException,MenuPrecedentException {
		...
		if (tabArt.retourner(code) == null) {
			...
			return (new Article42(code, design, Float.parseFloat(prixu)));
		} else
			return null;
	}
	...
	public void modifArticle42(TableArticles42 tabArt,int code) throws AbandonException,MenuPrecedentException {
