...
public class Client61 implements Serializable{
	...
	public Client61(String name, String lieu, String numero)
	{
	...
	public Client61(String name, String lieu, int numero)
	{
		this.chiffre_affaire = 0;
		this.nb_cde = 0;
		this.name = name;
	...
	{
		String[] ret = {getNumclient(), ""+getChiffre_affaire(), ""+getNb_cde(), getName(), getLieu(), ""+getDate()};
		return ret;
	}
