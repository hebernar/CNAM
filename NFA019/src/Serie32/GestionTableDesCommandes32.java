...
public class GestionTableDesCommandes32 {
	...
	public void creer(TableDesCommandes22 tabCde, TableArticles22 tabArt, int numCde) throws AbandonException,MenuPrecedentException {

		TableLigneDeCommande22<Integer> cde = new TableLigneDeCommande22<Integer>();
		cde.setNumcommande(numCde);
		GestionTableLigneDeCommande32 gtldc = new GestionTableLigneDeCommande32();
	...
	public void supprimer(TableDesCommandes22 tabCde) throws AbandonException,MenuPrecedentException {
		...
		if (tabCde.taille() != 0) {
			int num = (Integer) es.saisie(tabCde.cle() + "quelle commande voulez vous supprimer ?\n", 0);
	...
	public void afficher(TableDesCommandes22 tabCde) throws AbandonException,MenuPrecedentException {
		...
		if (tabCde.taille() != 0) {
			int num = (Integer) es.saisie(tabCde.cle() + "quelle commande voulez vous visualiser ?\n", 0);
			TableLigneDeCommande22<Integer> cde = tabCde.retourner(num);
			if (cde != null) {
				GestionTableLigneDeCommande32 gtldc1 = new GestionTableLigneDeCommande32();
				gtldc1.afficher(cde);
			} else
				es.affiche("Commande introuvable !");
		} else
	...
	public void facturer(TableDesCommandes22 tabCde, TableArticles22 tabArt) throws AbandonException,MenuPrecedentException {
		...
		if (tabCde.taille() != 0) {
			int num = (Integer) es.saisie(tabCde.cle() + "quelle commande voulez vous facturer ?", 0);
			TableLigneDeCommande22<Integer> cde = tabCde.retourner(num);
			if (cde != null) {
				GestionTableLigneDeCommande32 gtldc2 = new GestionTableLigneDeCommande32();
				gtldc2.afficher(cde);
			} else
				es.affiche("Commande introuvable !");
		} else
	...
	public void modifier(TableDesCommandes22 tabCde, TableArticles22 tabArt) throws AbandonException,MenuPrecedentException {
		...
		if (tabCde.taille() != 0) {
			int num = (Integer) es.saisie(tabCde.cle() + "quelle commande voulez vous modifier ?", 0);
			TableLigneDeCommande22<Integer> cde = tabCde.retourner(num);
			if (cde != null) {
				GestionTableLigneDeCommande32 gtldc3 = new GestionTableLigneDeCommande32();
				gtldc3.afficher(cde);
				if (cde.taille() == 0)
					tabCde.supprimer(num);
			} else
