...
public class FrameFacAffiche extends JFrame implements ActionListener {
	...
	public FrameFacAffiche(TableArticles61 tabArt, TableDesCommandes61 tabCde, TableFactures61 tabFact) {
		...
		JLabel id = new JLabel("Choisisssez la facture a afficher:");
	...
	public void actionPerformed(ActionEvent event) {
		...
		else if (event.getActionCommand() == "Valider") 
		{
			...
			if (tabFact.retourner(num) == null) 				{
				...
				new FrameFacAffiche2(tabArt, tabCde, tabFact, num);			
		}
	}
}
