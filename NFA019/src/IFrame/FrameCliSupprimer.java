...
public class FrameCliSupprimer extends JFrame implements ActionListener {
	...
	public FrameCliSupprimer(TableClient61 tabClient, TableDesCommandes61 tabCde) {
		...
		JLabel id = new JLabel("Choisisssez le compte client a supprimer :");
	...
	public void actionPerformed(ActionEvent event) {
		...
		else if (event.getActionCommand() == "Valider") 
		{
			...
			{
				tabCde.purgeClient(num);
				tabClient.supprimer(num);
				es.affiche("compte client nº  "+num+" supprime !", new ImageIcon(this.getClass().getResource("valid-icon.png")));
				new FrameGestionTableDesClient61(tabClient, tabCde);
			}			
		}
	}
