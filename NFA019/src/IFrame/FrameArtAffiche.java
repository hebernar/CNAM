...
public class FrameArtAffiche extends JFrame implements ActionListener{
	
	private TableArticles61 tabArt;
	private TableDesCommandes61 tabCde;
	private JButton valid;
	
	public FrameArtAffiche(TableArticles61 tabArt, TableDesCommandes61 tabCde) {
		this.tabArt = tabArt;
		this.tabCde = tabCde;
		String [][] data = tabArt.data();
		String[] label = tabArt.label();
		setLayout(new GridBagLayout());
		setSize(600, 150+20*tabArt.taille());
		...
		JLabel id = new JLabel("Table des articles :");
