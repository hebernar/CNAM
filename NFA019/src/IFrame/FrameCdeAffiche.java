...
public class FrameCdeAffiche extends JFrame implements ActionListener {
	...
	public FrameCdeAffiche(TableArticles61 tabArt, TableDesCommandes61 tabCde, TableClient61 tabClient) {
		...
		JLabel id = new JLabel("Choisisssez la commande a afficher:");
