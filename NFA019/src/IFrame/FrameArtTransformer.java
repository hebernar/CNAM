...
public class FrameArtTransformer extends JFrame implements ActionListener{
	...
	public FrameArtTransformer(TableArticles61 tabArt, TableDesCommandes61 tabCde) {
		...
		JLabel id = new JLabel("Choisisssez l'article a transformer dans la table:");
		...
		else if (event.getActionCommand() == "Valider")
		{
			...
			try 
			{
				...
				if (art == null)
				{
					...
					new FrameArtTransformer2(tabArt, tabCde, code);
			}
