...
public class FrameArtModifier extends JFrame implements ActionListener {
	...
	public FrameArtModifier(TableArticles61 tabArt, TableDesCommandes61 tabCde) {
		...
		JLabel id = new JLabel("Choisisssez l'article a modifier dans la table:");
		...
		else if (event.getActionCommand() == "Valider") 
		{
			...
			try {
				...
				if (art == null) 
				{
					...
					new FrameArtModifier2(tabArt, tabCde, code);
